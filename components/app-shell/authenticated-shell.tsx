...
import { CalendarDays, GraduationCap, Home, Megaphone, Search, Settings } from "lucide-react";
...
export function AuthenticatedShell({ user, children }: { user: User | null; children: React.ReactNode }) {
  ...
  return <div className="min-h-screen bg-cronopios-paper">
    ...
    <main className="md:ml-64"><div className="mx-auto max-w-6xl p-5 pb-28 md:p-10"><DashboardHeader name={name} />{children}</div></main>
