...
export function AcademicDeadlineCard({ title, detail, sourceLabel, sourceUpdatedAt, eventType, urgency, href = "/agenda" }: AcademicDeadlineCardProps) {
  return (
    <article className="relative border-2 border-cronopios-ink bg-cronopios-magenta p-4 shadow-[6px_6px_0_0_#221E21]">
      ...
      <div className="relative flex items-start gap-4 text-ink">
        ...
        <div>
          <p className="font-mono text-[11px] font-bold uppercase tracking-[0.16em]">Próxima fecha{eventType ? ` · ${eventType}` : ""}</p>
