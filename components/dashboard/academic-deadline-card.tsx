    ...
    <article className="relative border-2 border-cronopios-ink bg-cronopios-magenta p-4 shadow-[6px_6px_0_0_#221E21]">
      ...
      <div className="relative flex items-start gap-4 text-ink">
        ...
        <div>
          ...
          <a href={href} className="mt-4 inline-block min-h-11 border-2 border-cronopios-ink bg-white px-3 py-2.5 text-sm font-bold shadow-[3px_3px_0_0_#221E21] hover:-translate-y-0.5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-cronopios-magenta">Ver agenda</a>
        </div>
      </div>
      </PaperScrap>
    </article>
