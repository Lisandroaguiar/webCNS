...
export function AdminSchedulesPanel({ initialSchedules, subjects }: { initialSchedules: Row[]; subjects: Subject[] }) {
  ...
  const editor = editing !== null && <section className={editorAnchor === null ? "card mt-5" : "mt-5 border-t-2 border-ink/15 pt-5"}><h2 className="font-display text-xl font-black">{editing === "new" ? "Nueva comisión" : "Editar horario"}</h2><div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
