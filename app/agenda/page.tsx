...
export default async function AgendaPage() {
  ...
  const [user, events] = await Promise.all([getCurrentUser(), getPublishedAcademicEvents()]);
  ...
  return <SessionAwareShell user={user}>
    <div className={user ? "" : "mx-auto max-w-6xl px-5 py-10 md:px-8"}>
      ...
      <h1 className="editorial-title mt-5 text-5xl md:text-6xl">Fechas FDA</h1>
      <p className="mt-4 max-w-2xl text-ink/65">Inscripciones, mesas, recesos y otras fechas académicas importantes.</p></PaperScrap>
